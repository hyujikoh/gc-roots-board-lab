...
> 상태: **진행 중** (default 프로필 4종 GC 로그 기록 완료. 셰넌도어/ZGC 의 k6 RPS·p99 는 미기록, 누수 프로필 미실행). 각 행은 `scripts/summarize-gc.sh --all` 이 출력하는 "비교표 행" 과 k6 요약(RPS, p99)을 옮겨 적는다.
